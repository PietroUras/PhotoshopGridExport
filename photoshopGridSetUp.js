// Divide the image horizontally and vertically with a step specified by the user by drawing rulers 
...
if (app.documents.length == 0) {
    ...
    var sliceHeight = parseInt(prompt("Enter the slice height in pixels:", parseInt(doc.height)), 10);
    ...
    if (isNaN(sliceWidth) || sliceWidth <= 0) {
        ...
        alert("The document's width must be divisible by " + sliceWidth + " pixels.");
    }
    // Check if the height is a valid number
        ...
        alert("The document's height must be divisible by " + sliceHeight + " pixels.");
    }
    ...
    // Divide the image into slices
        ...
        // Get the PSD document folder path
